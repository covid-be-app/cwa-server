...
public class AcCounter {
  ...
  private static final String SUBMISSION_CONTROLLER_REQUESTS_COUNTER_NAME = "submission_controller.authorizationcode";
  private static final String SUBMISSION_CONTROLLER_REQUESTS_COUNTER_DESCRIPTION
      = "Counts authorization codes for the Submission Controller.";

  private final long batchSize;
  private final Counter counter;
  private final AtomicLong count = new AtomicLong(0L);

  AcCounter(MeterRegistry meterRegistry, long batchSize, String type) {
  ...
  /**
   * Increments the {@link AcCounter}. If the batch size is reached, it is provided to monitoring, else, the internal
