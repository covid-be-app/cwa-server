 ...
 */
public class CoviCodeCounter {

  private static final String SUBMISSION_CONTROLLER_REQUESTS_COUNTER_NAME = "submission_controller.covicodes";
  ...
  CoviCodeCounter(MeterRegistry meterRegistry, long batchSize, String type) {
  ...
  /**
   * Increments the {@link CoviCodeCounter}.
   * If the batch size is reached, it is provided to monitoring, else, the internal
   * If the batch size is reached, it is provided to monitoring, else, the internal
