...
public class DiagnosisKeyServiceTestHelper {
  ...
  public static DiagnosisKey buildVerifiedDiagnosisKeyForSubmissionTimestamp(long submissionTimeStamp) {
    return buildDiagnosisKeyForSubmissionTimestamp(true,submissionTimeStamp, makeRollingStartIntervalFromSubmission(submissionTimeStamp), true, "BE",
        Set.of("BE"), ReportType.CONFIRMED_TEST);
  }

  public static DiagnosisKey buildUnverifiedDiagnosisKeyForSubmissionTimestamp(long submissionTimeStamp) {
    return buildDiagnosisKeyForSubmissionTimestamp(false,submissionTimeStamp, makeRollingStartIntervalFromSubmission(submissionTimeStamp), true, "BE",
        Set.of("BE"), ReportType.CONFIRMED_TEST);
  }

  private static DiagnosisKey buildDiagnosisKeyForSubmissionTimestamp(
      boolean verified, long submissionTimeStamp, int rollingStartInterval,
  ...
  private static DiagnosisKey buildDiagnosisKeyForSubmissionTimestamp(
      long submissionTimeStamp, int rollingStartInterval,
      boolean consentToFederation, String countryCode, Set<String> visitedCountries, ReportType reportType) {
    return buildDiagnosisKeyForSubmissionTimestamp(
        true,
        submissionTimeStamp,
  ...
  public static DiagnosisKey buildDiagnosisKeyForSubmissionTimestamp(long submissionTimeStamp,
    ...
    return buildDiagnosisKeyForSubmissionTimestamp(submissionTimeStamp, rollingStartInterval, consentToShare, "BE",
        Set.of("BE"), ReportType.CONFIRMED_TEST);
  }
